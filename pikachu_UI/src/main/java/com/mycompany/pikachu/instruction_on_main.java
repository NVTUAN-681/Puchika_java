 ...
 * @author laptop
 */
public class instruction_on_main extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(instruction_on_main.class.getName());

    /**
     * Creates new form instruction_on_main
     */
    public instruction_on_main() {
        setContentPane(new Instruction_backGround());
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new instruction_on_main().setVisible(true));
    }
