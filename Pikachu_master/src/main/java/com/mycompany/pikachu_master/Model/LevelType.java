...
public class LevelType {
    ...
    public static final LevelType ASIAN = new LevelType("ASIAN", 10, 20, 180, 45, true, true);
    
    public static final LevelType EASY = new LevelType("EASY", 6, 10, 240, 18, false, false);
    public static final LevelType NORMAL = new LevelType("NORMAL", 8, 12, 240, 36, false, false);
